class Lexico:
  ...
  def erro_identificador_invalido(self):
    ...
    """
    print(f'mo! ಠಿ_ಠ Erro léxico: identificador inválido [ {self.lexema} ] na linha {self.linha_atual}.')
    exit()
  ...
  def erro_caractere_invalido(self):
    ...
    """
    print(f'mo! ಠಿ_ಠ Erro léxico: caractere inválido [ {self.caractere_atual} ] na linha {self.linha_atual}.')
    exit()
  ...
  def erro_comentario_invalido(self):
    ...
    """
    print(f'mo! ಠಿ_ಠ Erro léxico: comentário inválido  [ {self.lexema} ] na linha {self.linha_atual}.')
    exit()
  ...
  def erro_digito_invalido(self):
    ...
    """
    print(f'mo! ಠಿ_ಠ Erro léxico: dígito inválido [ {self.lexema} ] na linha {self.linha_atual}.')
    exit()
